...
class PandasDataPreprocessor(DataPreprocessor):
    ...
    def load(self, path):
        ...
        with open(path, 'rb') as f:
            obj = pickle.load(f)
        self.cols_category_mapping = obj['cols_category_mapping']
        self.cols_log_norm_maxes = obj['cols_log_norm_maxes']
        self.time_transformation = obj['time_transformation']
        self.time_min = obj['time_min']

    def save(self, path):
        obj = {
            'cols_category_mapping': self.cols_category_mapping,
            'cols_log_norm_maxes': self.cols_log_norm_maxes,
